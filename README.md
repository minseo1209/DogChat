...
### 프로젝트 목적
강아지 알러지를 보유한 디지털 집사들 위해 온라인경험을 제공하고자  '멍채팅' 이라는 강아지 채팅 웹 서비스를 개발했습니다.
...
- **모바일 화면 개선** : 현재는 화면 크기가 미흡하여, 모바일 화면에서의 사용성이 좋지 않습니다. 모바일 환경에 적합한 디자인 및 레이아웃을 구현하여 사용자 경험을 향상시킬 예정입니다.
